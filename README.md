...
✨ Features:  
- Real-time RFID tag reading and storage  
- Product–Tag association (One-to-One mapping)  
- RESTful APIs with Spring Boot  
- JWT-based authentication and user management  
- Modern React frontend with reusable components (TableTemplate)  
- MySQL database integration  
- Embedded/IoT device communication  
